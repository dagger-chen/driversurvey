...
public class FourHistogramView extends View implements Runnable {

	private static final String TAG = FourHistogramView.class.getSimpleName();

	private boolean isAnimSecond = false;
	...
	private double progress1; // 设置进度 1为最大值
	private double progress2; // 第二段进度
	...
	public FourHistogramView(Context context, AttributeSet attrs,
			int defStyleAttr) {
	...
	public FourHistogramView(Context context) {
		super(context);
	}
